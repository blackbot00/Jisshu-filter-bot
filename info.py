...
BOT_TOKEN = environ.get('BOT_TOKEN', '7652210903:AAF6-6rYdWuPnxVUVMMnwDB85k9JfwVMW1w')
#---------------------------------------------------------------
#---------------------------------------------------------------
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5707498585').split()]
USERNAME = environ.get('USERNAME', "https://t.me/black_bot_2") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002337440548'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', 'https://t.me/moviehubsearchgroup')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001692857281').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://worm2807:D615k1OLJjP1bfzG@cluster0.mtp42.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
auth_channel = environ.get('AUTH_CHANNEL', '-1001644247336')
sUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', 'https://t.me/+liSMeNJ-2GQ4NzA9'))
...
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002267948275')) # 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/hk_support_group') #Support group link ( make sure bot is admin )
#---------------------------------------------------------------
#---------------------------------------------------------------
IS_VERIFY = is_enabled('IS_VERIFY', True)
#---------------------------------------------------------------
TUTORIAL = environ.get("TUTORIAL", "https://t.me/main_movie_hub")
TUTORIAL_2 = environ.get("TUTORIAL_2", "https://t.me/main_movie_hub")
TUTORIAL_3 = environ.get("TUTORIAL_3", "https://t.me/main_movie_hub")
VERIFY_IMG = environ.get("VERIFY_IMG", "https://graph.org/file/1669ab9af68eaa62c3ca4.jpg")
SHORTENER_API = environ.get("SHORTENER_API", "ffb1b16a5cc0396ee306d67bfcea3dbf9da5dcbd")
SHORTENER_WEBSITE = environ.get("SHORTENER_WEBSITE", 'upshrink.com')
SHORTENER_API2 = environ.get("SHORTENER_API2", "ffb1b16a5cc0396ee306d67bfcea3dbf9da5dcbd")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'upshrink.com')
SHORTENER_API3 = environ.get("SHORTENER_API3", "ffb1b16a5cc0396ee306d67bfcea3dbf9da5dcbd")
...
#---------------------------------------------------------------
#---------------------------------------------------------------
START_IMG = (environ.get('START_IMG', 'https://cdn.jsdelivr.net/gh/Harmish77/Data@main/images.png')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://i.ibb.co/ZNC1Hnb/ad3f2c88a8f2.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://cdn.jsdelivr.net/gh/Harmish77/Data@main/photo_2024-12-25_17-13-37.jpg')).split()
